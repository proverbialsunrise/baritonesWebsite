...
exports.getImagesForPhotosPage = getImagesForPhotosPage;
...
function getImagesForPhotosPage(callback) {
  var dirPath = "public/img/perform/";
  glob(dirPath+"*.jpg", function (er, files) {
    var numberOfImages = files.length;
    var images = [];
    for (var i = 0; i < numberOfImages; i++) {
      var image = {}
      var filename = files[i];
      var usefulFilename = filename.substring(7);
      image.filename = usefulFilename;
      console.log(image)
